...
const adminLoginFormSchema = z.object({
  ...
  password: z.string().min(1, 'Password is required').max(64, 'Password must not be longer than 64 characters.'),
})
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card>
        ...
        <CardContent>
          <Form {...adminLoginForm}>
            <form onSubmit={adminLoginForm.handleSubmit((data) => {handleAdminLogin(data)})} className="space-y-6">
              <FormField
